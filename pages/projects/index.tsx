    ...
    <Layout>
      ...
      <div className="bg-indigo-700 text-white">
        <div className="container-wide py-16">
          ...
          <p className="mt-4 text-lg text-indigo-100 max-w-3xl">
            A collection of my work in data analysis, visualization, and
      ...
      <section className="py-16 bg-white">
        <div className="container-wide">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Excel Box */}
            <div className="bg-green-50 border border-green-100 p-6 rounded-lg flex flex-col h-full">
              ...
              <p className="text-gray-600 mb-4">
                Advanced dashboards, data models, and automated reporting
                solutions built with Excel and Google Sheets.
              </p>
              <button
                onClick={() => {
            ...
            {/* Python Box */}
            <div className="bg-blue-50 border border-blue-100 p-6 rounded-lg flex flex-col h-full">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600 mb-4">
                Data analysis, machine learning, and visualization projects
                developed with Python and its data science libraries.
              </p>
              <button
                onClick={() => {
            ...
            {/* SQL Box */}
            <div className="bg-purple-50 border border-purple-100 p-6 rounded-lg flex flex-col h-full">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600 mb-4">
                Database optimization, complex query development, and data
                extraction solutions using SQL.
              </p>
              <button
                onClick={() => {
                  setActiveFilter('sql');
            ...
            {/* Power BI Box */}
            <div className="bg-yellow-50 border border-yellow-100 p-6 rounded-lg flex flex-col h-full">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600 mb-4">
                ...
                Tableau, and other business intelligence tools.
              </p>
              <button
                onClick={() => {
      ...
      <section className="py-12 bg-indigo-700 text-white">
        <div className="container-narrow text-center">
          <h2 className="text-2xl md:text-3xl text-indigo-100 font-bold mb-4">
            Want to Work Together?
          </h2>
          <p className="text-lg text-indigo-100 mb-8 max-w-2xl mx-auto">
            If you like my work and want to discuss a potential project or
